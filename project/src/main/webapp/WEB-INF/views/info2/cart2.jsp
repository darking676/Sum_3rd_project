							...
							<table class="table">
								...
								<tr class="text-center" >
									<td>
										...
										style="width: 150px; transform:translateX(40px) " align="right"  hspace="30" >
									</td>
									<td>
									...
									<td style="width: 80px; transform:translateX(-44px)" align="right">
									...
									<td class="text-center">
										...
										<input type="hidden" name="productNum" value="${cartVo.productNum }" />개&nbsp; <button type="submit" id="btnUpdate" class="btn btn-info btn-sm active">수정</button>&nbsp;&nbsp;
									</td>
									<td style="width: 100px; transform:translateX(-42px)" align="right">
										&#8361;<fmt:formatNumber pattern="###,###,###" value="${cartVo.sumPrice }" />
									</td>
									<td>
										<button type="button" id="btnDel" class="btn btn-info btn-sm active" onclick="location.href='/shop01/cart2/delete/?basketNum=${cartVo.basketNum }'">삭제</button>
<%-- 										<a href="/shop01/cart2/delete/?basketNum=${cartVo.basketNum }">삭제</a></button> --%>
									</td>
								</tr>
								</c:forEach>
								<tr>
