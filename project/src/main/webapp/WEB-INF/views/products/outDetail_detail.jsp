			...
			<div id="container">
				<div id="content" style="min-height: 800px;">
					...
					<img src="../resources/imgs2/${thisProductsVo.product_url }" alt="..."
						style="width: 600px; transform: translateX(-250px)" align=left
						hspace=20>
					<div id="outer">
						...
						<hr class="line2" style="transform: translateX(-250px)">
						<h4 style="transform: translateX(-250px)">code :
							${thisProductsVo.productNum}</h4>
						<h4 style="transform: translateX(-250px)">price :
							${thisProductsVo.price}원</h4>
						...
						<form id="viewForm" action="/shop01/outer_detail/" method="get">
							<p>
								<input type="hidden" name="productNum" /> <input type="hidden"
									...
									name="curPage" value="${param.curPage }" /> <input
						...
						<form id="modifyForm" action="/shop01/outer_edit/" method="get">
							<p>
								<input type="hidden" name="productNum"
									value="${param.productNum }" /> <input type="hidden"
									name="procd" value="${param.procd }" /> <input type="hidden"
									name="curPage" value="${param.curPage }" /> <input
									type="hidden" name="searchWord" value="${param.searchWord }" />
							</p>
