					...
					<div id="bbs">
						...
						<c:forEach var="comment" items="${commentList }"
							...
							<div class="comments">
								...
								<h6>
								<c:if test="${sessionScope.check.memName == '관리자' }">
								...
								<div class="modify-comment">
									<form id="modifyCommentForm${comment.commentno }"
										action="/shop01/rev_bbs_detail3/commentUpdate/" method="post" style="display: none;">
										<p>
                     ...
                     <br clear=left>
						...
						<form id="addCommentForm" action="/shop01/rev_bbs_detail3/commentAdd/" method="post">
							...
							<div id="addComment">
								<textarea name="memo" rows="7" cols="72"></textarea>
							</div>
							<br />
