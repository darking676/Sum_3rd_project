					...
					<div id="bbs">
						...
						<c:forEach var="comment" items="${commentList }"
							...
							<hr class="line">
								...
								<h6>
								<c:if test="${sessionScope.check.memId == manager }">
								...
								<div class="modify-comment">
									<form id="modifyCommentForm${comment.commentno }"
										action="/shop01/rev_bbs_detail2/commentUpdate/" method="post" style="display: none;">
										<p>
...
<!-- 							</div> -->
						...
						<div id="view-menu">
							<div>
							<c:if test="${sessionScope.check.memId == thisBbsVo.memId }">
